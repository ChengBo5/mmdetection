...
class GFLHead(AnchorHead):
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, labels, label_weights,
        ...
        if len(pos_inds) > 0:
            ...
            weight_targets = torch.tensor(0).to(bbox_pred.device)
    ...
    def loss(self,
        ...
        return dict(
            rpn_loss_cls=losses_cls, rpn_loss_bbox=losses_bbox, rpn_loss_dfl=losses_dfl)
    ...
    def _get_bboxes_single(self,
        ...
        if with_nms:
            ...
            dets, keep = batched_nms(mlvl_bboxes, mlvl_scores.contiguous(), labels.contiguous(), cfg.nms)
