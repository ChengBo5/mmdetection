        ...
        if show or out_dir:
            ...
            for i, (img, img_meta) in enumerate(zip(imgs, img_metas)):
                ...
                if model.module.test_cfg.text_dataset_type == 'ICDAR2015':
                    ...
                    with open('{}'.format(os.path.join('evaluate/icdar2015_evalu/res_mask', 'res_{}.txt'.format(image_name))), 'w') as f:
                        import cv2
                    ...
                    image_name = img_metas[0]['ori_filename'][0:-4]
                    with open('{}'.format(os.path.join('evaluate/ctw1500_evalu/predict1', '{}.txt'.format(image_name))), 'w') as f:
